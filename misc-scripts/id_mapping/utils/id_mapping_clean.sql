...
SELECT COUNT(*) FROM rnaproduct_stable_id;
...
CREATE TABLE rnaproduct_stable_id_bak SELECT * FROM rnaproduct_stable_id;
...
DELETE FROM rnaproduct_stable_id;
...
DROP TABLE rnaproduct_stable_id_bak;
